...
@InputType()
class EnergyConsumptionCreateNestedManyWithoutBuildingsInput {
...
export { EnergyConsumptionCreateNestedManyWithoutBuildingsInput as EnergyConsumptionCreateNestedManyWithoutBuildingsInput };
