...
@InputType()
class HvacSystemCreateNestedManyWithoutBuildingsInput {
...
export { HvacSystemCreateNestedManyWithoutBuildingsInput as HvacSystemCreateNestedManyWithoutBuildingsInput };
