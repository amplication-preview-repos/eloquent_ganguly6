...
const CREATE_INPUT = {
  ...
  id: "exampleId",
  implemented: "true",
  recommendationText: "exampleRecommendationText",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  createdAt: new Date(),
  ...
  test("POST /recommendations", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateRecommended: CREATE_RESULT.dateRecommended.toISOString(),
      ...
      .expect([
        {
          ...
          dateRecommended: FIND_MANY_RESULT[0].dateRecommended.toISOString(),
  ...
  test("GET /recommendations/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateRecommended: FIND_ONE_RESULT.dateRecommended.toISOString(),
